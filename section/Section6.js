const Section6 = function () {
    ...
    return () => {
        ...
        const i1_2 = MMedia("image-thread_blocking", [MImage("./asset/image/thread_blocking.svg")])
        const t1_2 = MText(`
        ...
        const p2 = MParagraph()
        const i2 = MMedia("image-nodejs", [MImage("./asset/image/nodejs.webp")])
        const t2 = MText(`
        ...
        const p4 = MParagraph()
        const i4 = MMedia("image-event_loop", [MImage("./asset/image/event_loop.svg")])
        const t4 = MText(`
