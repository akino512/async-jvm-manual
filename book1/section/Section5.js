GLOBAL.sections.push({
    ...
    read: function () {
        ...
        const p1 = MParagraph()
        const v1 = MMedia("video-app-3-1", [MVideo("app-3-1.mp4")])
        const i1 = MMedia("image-app-3-1", [MImage("app-3-1.png")])
        const t1 = MText(`
        ...
        const p2 = MParagraph()
        const v2 = MMedia("video-app-3-2", [MVideo("app-3-2.mp4")])
        const i2 = MMedia("image-app-3-2", [MImage("app-3-2.png")])
        const t2 = MText(`
        ...
        const p3 = MParagraph()
        const v3 = MMedia("video-app-3-2(5000req)", [MVideo("app-3-2(5000req).mp4")])
        const i3 = MMedia("image-app-3-2(5000req)", [MImage("app-3-2(5000req).png")])
        const t3 = MText(`
        ...
        const p4 = MParagraph()
        const v4 = MMedia("video-app-3-2(10000req)", [MVideo("app-3-2(10000req).mp4")])
        const i4 = MMedia("image-app-3-2(10000req)", [MImage("app-3-2(10000req).png")])
        const t4 = MText(`
