GLOBAL.sections.push({
    ...
    read: function () {
        ...
        const p1 = MParagraph()
        const i1 = MMedia("image-app-4-1", [MImage("app-4-1.png")])
        ...
        const p2 = MParagraph()
        const v2 = MMedia("video-app-4-1", [MVideo("app-4-1.mp4")])
        ...
        const p3 = MParagraph()
        const v3 = MMedia("video-app-4-2", [MVideo("app-4-2.mp4")])
        const i3 = MMedia("image-app-4-2",
            [MImage("app-4-2(1).png"), MImage("app-4-2(2).png")])
