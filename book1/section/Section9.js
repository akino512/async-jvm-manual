GLOBAL.sections.push({
    ...
    read: function () {
        ...
        const p2 = MParagraph()
        const i2 = MMedia("image-app-5-2", [MImage("app-5-2.png")])
        const t2 = MText(`另一个方面，随着业务的增长，回调嵌套层数也将增加。<br />
        假设扣款服务逻辑更加复杂，如image-app-5-2。<br />
        多层的回调嵌套将导致代码逻辑耦合杂乱，难以阅读。<br />`)

        const p3 = MParagraph()
        const i3 = MMedia("image-cshap_await", [MImage("cshap_await.png")])
